...
import { getLangChainService, UserPreferences } from '@/lib/services/fertility-ai';
...
export default function RecommendationsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const results = langChainService.recommendHospitals(preferences);
                ...
                <div key={hospital.id} className="bg-white rounded-lg shadow-md p-5 border-l-4 border-blue-500">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {hospital.careType.map((care: string) => (
                        <span 
                          key={care}
